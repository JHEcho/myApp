...
import com.codezen.myapp.domain.Entry;
import com.codezen.myapp.repository.EntryRepository;
...
/**
 * REST controller for managing {@link com.codezen.myapp.domain.Entry}.
 */
@RestController
@RequestMapping("/api")
@Transactional
